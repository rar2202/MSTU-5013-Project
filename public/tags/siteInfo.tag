<siteinfo>
      ...
      <div class="col-md-6">
        <section class="card mb-5 border-gray bg-white" id="parents">
          <div class="card-header bg-info">
            <h3 class="card-title center"> <strong> Parent Information </strong> </h3>
          </div>
          <div class="card-body">
  ...
  <!-- student information -->
    <div class="col-md-6">
      <section class="card mb-5 border-gray bg-white" id="students">
        <div class="card-header bg-success">
          <h3 class="card-title center"> <strong> Student Information </strong> </h3>
        </div>
        <div class="card-body">
          <h5 class="card-subtitle"><b> Directions For Students </b><h5>
